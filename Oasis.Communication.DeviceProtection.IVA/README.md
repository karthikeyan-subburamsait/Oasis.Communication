# Oasis.Communication.DeviceProtection.IVA
...
- In a terminal, navigate to `Oasis.Communication.DeviceProtection.IVA`

    ```bash
    # change into project folder
    cd Oasis.Communication.DeviceProtection.IVA
    ```
...
- Run the bot from a terminal or from Visual Studio, choose option A or B.
  ...
  - Navigate to `Oasis.Communication.DeviceProtection.IVA` folder
  - Select `Oasis.Communication.DeviceProtection.IVA.csproj` file
